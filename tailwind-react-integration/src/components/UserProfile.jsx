...
function UserProfile() {
  return (
    <div className="bg-gray-100 md:p-8 sm:p-4 max-w-xs md:max-w-sm mx-auto my-20 rounded-lg shadow-lg"user-profile>
      <img className="rounded-full mx-auto sm:w-24 h-sm:h-24 md:w-36 md:h-36" src="https://via.placeholder.com/150" alt="User" />
      <h1 className="md:text-xl text-lg-sm text-blue-800 my-4">John Doe</h1>
